...
1) Display color in a square
2) Apply colorpicker in the app
3) Have changing colorpicker result in a square rendering that color
4) Case needs a color and a default
5) Make in one file
6) State is an object with a color prop
7) src/index.js, src/App.js, src/store.js
